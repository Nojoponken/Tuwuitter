...
describe('Friend request', () => {
    ...
    it('Accept friend request incorrect method', async () => {
        let response = await handleError(agent
            .get(`localhost:${port}/request/accept`)
            .send());
...
describe('Posting on friend page', () => {
    ...
    it('Make too long post', async () => {
        let response = await handleError(agent
            .post(`localhost:${port}/posts`)
            .send({ 'message': 'i live in your walls i live in your walls i live in your walls i live in your walls i live in your walls i live in your walls i live in your walls i live in your walls i live in your walls i live in your walls i live in your walls i live in your walls', 'profile': 'JaneDoe' }));
        assert.equal(response.status, 400);
    });
});
...
describe('Find users', () => {
    ...
    it('Search for users friends', async () => {
        let response = await handleError(agent
            .get(`localhost:${port}/friend/JaneDoe`)
            .send());
        assert.equal(response.status, 200);
    });
    ...
    it('Search for users friends incorrect method', async () => {
        let response = await handleError(agent
            .post(`localhost:${port}/friend/JaneDoe`)
            .send());
        assert.equal(response.status, 405);
    });
    ...
    it('Search for users friends not found', async () => {
        let response = await handleError(agent
            .get(`localhost:${port}/friend/JaneDDDoe`)
            .send());
...
describe('Denying friend request', () => {
    ...
    it('Deny friend request incorrect method', async () => {
        let response = await handleError(agent
            .get(`localhost:${port}/request/deny`)
            .send());
        assert.equal(response.status, 405)
    });
...
describe('Getting posts and marking posts read ', () => {
    it('Getting post', async () => {
        let response = await handleError(agent
            .get(`localhost:${port}/posts/JohnDoe`)
            .send());
        assert.equal(response.status, 200);
    });
    ...
    it('Getting post wrong method', async () => {
        let response = await handleError(agent
            .post(`localhost:${port}/posts/JohnDoe`)
            .send())
        assert.equal(response.status, 405);
    });
    ...
    it('Mark post read', async () => {
        //get posts
        let posts = await handleError(agent
            .get(`localhost:${port}/posts/JohnDoe`)
            .send());
        //get first post id
